...
<html lang="en">
  <head>
    ...
    <title>Ducts - Decentralized Application</title>
  ...
  <center>
    ...
    <div style="width: 100%">
      ...
      <div class="loginformcard" id="card1">
            <h4> Welcome to Ducts</h4>
            <p style="max-width: 80%;">
            Ducts is a Decentralized Drug Tracking Application that stores the whereabouts of product at every freight hub on the Blockchain. At consumer end, customers can simply scan the QR CODE of products and get complete information about the provenance of that product hence empowering consumers to only purchase authentic and quality products.
            </p>
      ...
      <div class="loginformcard" id="maincard3">
            ...
            <div class="g-recaptcha" data-sitekey="6Le6XCEfAAAAAM8V0HsqgUjoAL1ujx72A8YEOT3Y"></div>
