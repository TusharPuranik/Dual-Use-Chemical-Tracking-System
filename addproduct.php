...
<html lang="en">
  <head>
    ...
    <title>Ducts - Add New Products</title>
  ...
  <body class="violetgradient">
            ...
            <div class="greyarea">
                ...
                <form id="form1" autocomplete="off">
                    <div class="formitem">
                        ...
                        <input type="text" class="forminput" id="quantity" required>
    ...
    $('#form1').on('submit', function(event) {
        ...
        prodname=prodname+"<br>Registered By: "+username+ "<br>Quantity : " + quantity;
